...
function changeTabPanel(e) {
    ...
    mainContainer.querySelectorAll('[role="tabpanel"]').forEach((panel) => panel.setAttribute("hidden", true));
     ...
     mainContainer.querySelectorAll('picture').forEach((image) => image.classList.add('hidden'));
...
function hideContent(parent, content) {
    parent.querySelectorAll(content).forEach((item) => panel.setAttribute("hidden", true));
}